<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="copies" label="打印联数" align="center" />
    ...
    <pagination
      ...
      @pagination="getList"
    />
    <printer-add v-if="addVisible" :visible.sync="addVisible" title="添加" />
    <printer-edit v-if="editVisible" :id="id" :visible.sync="editVisible" title="编辑" />
  </div>
</template>

<script>
import { list, doStatus, doRemove } from '@/api/setting/printer'
import { batchHandle } from '@/utils'
import Pagination from '@/components/Pagination'
import PrinterAdd from './printer/add'
import PrinterEdit from './printer/edit'
