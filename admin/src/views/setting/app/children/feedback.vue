<template>
  <div class="app-container">
    ...
    <pagination
      ...
      @pagination="getList"
    />
    <feedback-add v-if="addVisible" :visible.sync="addVisible" title="添加" />
    <feedback-edit v-if="editVisible" :id="id" :visible.sync="editVisible" title="编辑" />
  </div>
</template>

<script>
import { list, doRemove } from '@/api/setting/feedback'
