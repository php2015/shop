<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="rule_name" label="协议名称" align="center" />
    ...
    <pagination
      ...
      @pagination="getList"
    />
    <rule-add v-if="addVisible" :visible.sync="addVisible" title="添加" />
    <rule-edit v-if="editVisible" :id="id" :visible.sync="editVisible" title="编辑" />
  </div>
</template>

<script>
import { list, doRemove } from '@/api/setting/rule'
