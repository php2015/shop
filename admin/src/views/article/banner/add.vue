  ...
  <div class="app-container">
    <el-form ref="form" v-loading="loading" :model="form" :rules="rules" label-width="20%">
      ...
      <el-form-item label="跳转地址" prop="redirect_site">
        <el-input v-model.trim="form.redirect_site" clearable placeholder="跳转地址" style="width:80%" />
      </el-form-item>
      <el-form-item label="排序" prop="sort">
        <el-input v-model.number="form.sort" clearable placeholder="数值越小越靠前" style="width:80%" />
...
<script>
import { add, doAdd } from '@/api/article/banner'
