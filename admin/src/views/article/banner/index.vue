  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        ...
        @click="$router.push('/article/banner/add')"
      >添加</el-button>
      <el-button
        style="margin-left: 10px;"
        type="danger"
    ...
    >
      ...
      <el-table-column label="跳转" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.redirect_type == 0" effect="dark" type="info">不跳转</el-tag>
          <el-tag v-if="scope.row.redirect_type == 1" effect="dark" type="success">跳转</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="redirect_site" label="跳转地址" align="center" />
      ...
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-link
            type="primary"
            icon="el-icon-edit-outline"
            @click="$router.push('/article/banner/edit/' + scope.row.id)"
          >编辑</el-link>
          <el-link
            type="danger"
            icon="el-icon-delete"
...
<script>
import { list, doStatus, doRemove } from '@/api/article/banner'
