    ...
    <el-dialog :title="title" :visible.sync="visible" :before-close="beforeClose">
      ...
      >
        <el-form-item label="用户名" prop="username">
          <el-input v-model="form.username" placeholder="用户名" style="width:80%" />
        </el-form-item>
        <el-form-item label="用户密码" prop="password">
          <el-input v-model="form.password" type="password" placeholder="用户密码" style="width:80%" />
        </el-form-item>
        ...
        <el-form-item label="邮箱" prop="email">
          <el-input v-model="form.email" placeholder="邮箱" style="width:80%" />
        </el-form-item>
        <el-form-item label="手机号" prop="phone">
          <el-input v-model="form.phone" placeholder="手机号" style="width:80%" />
        </el-form-item>
