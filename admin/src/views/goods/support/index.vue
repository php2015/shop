  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        ...
        @click="$router.push('/goods/support/add')"
      >添加</el-button>
    </div>
    <el-divider />
    ...
    >
      <el-table-column prop="support_name" label="支持名称" align="center" />
      ...
      <el-table-column fixed="right" label="操作" width="150" align="center">
        <template slot-scope="scope">
          <el-link
            type="primary"
            icon="el-icon-edit-outline"
            @click="$router.push('/goods/support/edit/' + scope.row.id)"
          >编辑</el-link>
          <el-link
            type="danger"
            icon="el-icon-delete"
...
<script>
import { list, doStatus, doRemove } from '@/api/goods/support'
