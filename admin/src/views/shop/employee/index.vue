  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        ...
        @click="$router.push('/shop/employee/add')"
      >添加</el-button>
    </div>
    <el-divider />
    ...
    >
      ...
      <el-table-column label="核销员" width="100" align="center">
        <template slot-scope="scope">
          <div style="line-height: 30px;">
            <el-tag v-if="scope.row.verify == 10">否</el-tag>
            <el-tag v-if="scope.row.verify == 20" type="success">是</el-tag>
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="150" align="center">
        <template slot-scope="scope">
          <el-link
            type="primary"
            icon="el-icon-edit-outline"
            @click="$router.push('/shop/employee/edit/' + scope.row.id)"
          >编辑</el-link>
...
<script>
import { list, doStatus, doRemove } from '@/api/shop/employee'
