  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        ...
        @click="$router.push('/shop/page/add')"
      >添加</el-button>
      <el-button
        style="margin-left: 10px;"
        type="danger"
      ...
      <el-table-column fixed="right" label="操作" width="150" align="center">
        <template slot-scope="scope">
          <el-link
            type="primary"
            icon="el-icon-edit-outline"
            @click="$router.push('/shop/page/edit/' + scope.row.id)"
          >编辑</el-link>
          <el-link
            type="primary"
            icon="el-icon-document-checked"
            @click="$router.push('/shop/page/design/' + scope.row.id)"
          >设计</el-link>
          <el-link
            type="danger"
            icon="el-icon-delete"
...
<script>
import { list, doStatus, doRemove } from '@/api/shop/page'
